...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    public class MemoryCacheManager : ICacheManager
    {
        ...
        //    var cacheEntriesFieldCollectionDefinition = typeof(MemoryCache).GetField("_coherenState", BindingFlags.NonPublic | BindingFlags.Instance);
        //    var cacheEntriesPropetyCollectionDefinition = typeof(MemoryCache).GetProperty("EntriesCcollection", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        //            (
        //            "EbtriesCollection", BindingFlags.NonPublic | BindingFlags.Instance
        //            );
